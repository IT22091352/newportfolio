            ...
            <div className="space-y-6">
              ...
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-sm text-dark-600 dark:text-gray-400 mt-1">Available weekdays 9 AM to 6 PM</p>
                </div>
              </div>
              ...
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <div className="flex mt-2 space-x-4">
                    <a href="https://github.com/chathuka-dilakshana" target="_blank" rel="noopener noreferrer" className="text-dark-600 dark:text-gray-400 hover:text-primary-600 dark:hover:text-primary-400">
                    ...
                    <a href="https://linkedin.com/chathuka-dilakshana" target="_blank" rel="noopener noreferrer" className="text-dark-600 dark:text-gray-400 hover:text-primary-600 dark:hover:text-primary-400">
                      <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
