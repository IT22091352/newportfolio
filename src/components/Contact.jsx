          ...
          >
            ...
            >
              ...
              <div className="space-y-6">
                ...
                <MagneticButton className="inline-flex w-full rounded-lg" disabled={loading}>
                  <motion.button
                    type="submit"
                    disabled={loading}
                    className="flex w-full items-center justify-center rounded-lg bg-slate-900 py-3 text-sm font-semibold text-white transition-colors hover:bg-slate-800 disabled:opacity-70 sm:text-base"
                  >
                  {loading ? (
                    <>
