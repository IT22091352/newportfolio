              ...
              {experiences[activeTab].map((item, index) => (
                <motion.div
                  ...
                  className={`relative mb-16 md:mb-8 ${
                    index % 2 === 0 ? 'md:ml-auto md:mr-1/2 md:pr-12 md:text-right' : 'md:ml-1/2 md:pl-12'
                  }`}
                  variants={revealUp}
                >
                  <div className={`absolute left-0 top-0 transform -translate-y-1/3 ${
                    index % 2 === 0 ? 'md:left-1/2 md:translate-x-0' : 'md:left-1/2 md:-translate-x-full'
                  }`}>
                  ...
                  <div className={`glass-panel rounded-2xl p-5 sm:p-6 ${index % 2 === 0 ? 'ml-12 md:ml-0' : 'ml-12'}`}>
