...
/**
 * Optimized Orbs component that disables on mobile
 * Reduces CPU/GPU load on mobile devices
 */
const AnimatedOrbsOptimized = () => {
  const isMobile = useIsMobile();

  // Skip rendering on mobile to save resources
  if (isMobile) {
    return (
...
export default AnimatedOrbsOptimized;
